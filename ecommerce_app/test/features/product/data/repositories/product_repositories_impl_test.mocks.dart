...
// in ecommerce_app/test/features/product/data/repositories/product_repositories_impl_test.dart.
...
/// A class which mocks [ProductLacalDatasource].
///
/// See the documentation for Mockito's code generation for more information.
class MockProductLacalDatasource extends _i1.Mock
    implements _i6.ProductLacalDatasource {
  MockProductLacalDatasource() {
    _i1.throwOnMissingStub(this);
  }
  ...
  @override
  _i5.Future<void> cacheProduct(_i2.Product? product) =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<List<_i2.Product>> getCachedProducts() =>
      (super.noSuchMethod(
  ...
  @override
  _i5.Future<_i2.Product> getCachedProductById(String? id) =>
      (super.noSuchMethod(
